            ...
            <div className="rules-page-layout">
                <main className="rules-container">
                    <section className="introduction">
                        <p>We are an independent series inspired by the original Juicebox Division. While we share a
                            common goal,
                    ...
                    <section className="rules-section">
                        ...
                        <p><strong><u>Ages 6–7:</u></strong> "Snack Pack" Radio Flyer Extreme Drift Go-Kart (36V only)
                        </p>
                        <p className="indented"><em>Note: The <strong>"Snack Pack"</strong> division is exclusive to the
                            Rockstars Series and is
                            <strong>not recognized</strong> by the Juicebox Division for events outside our series.</em>
                        </p>
                        <p><strong><u>Driver Age Policy:</u></strong> A driver’s age as of <strong>January 1,
                            2025</strong> determines their
                            division for the entire year.</p>
                        <p className="indented"><em>Example:</em> If your child is <strong>4 years old</strong> as of
                            January 1, 2025, they will remain in
                    ...
                    <section className="rules-section">
                        ...
                        <p>(This rule applies to performance-related components. Modifications such as custom bodies,
                            body bracing,
                        ...
                        <ul className="indent-bullets">
                            ...
                            <li><strong>Plastic tires only:</strong> No rubber bands, bed liner spray, or additional
                                traction aids.
                            </li>
                        </ul>
                    </section>
                    ...
                    <section className="rules-section">
                        ...
                        <ul className="no-bullets">
                            <li><strong><u>Helmets:</u></strong> Required (Bicycle helmets are the minimum standard).
                            </li>
                    ...
                    <section className="rules-section">
                        ...
                        <ul className="no-bullets">
                            ...
                            <li><strong><u>Ages 6–7 ("Snack Pack"):</u></strong> Rolling start, 2x2 formation, in first
                                gear. Shift to
                                third gear when the <strong><span
                                    style={{color: 'green'}}>green flag</span></strong> drops.
                            </li>
                        </ul>
                    </section>
                    ...
                    <section className="rules-section">
                        ...
                        <p><strong><u>Pre-Registration:</u></strong> Event registration will have a cut-off time,
                            announced with
                            event details.</p>
                        <p>If you do not have Facebook, you may register <strong>by phone:</strong> (910) 237-1343.</p>
                        <h3>Penalties & Disqualifications</h3>
                        <p><strong><u>Tech Inspection:</u></strong> Any driver who fails tech inspection will not
                            receive awards and must
                            correct the issue before the next event.</p>
                        <p><strong><u>Intentional cheating:</u></strong> Will result in immediate disqualification and
                            removal from the
                            series.</p>
                        <p className="warning"><strong><span
                            style={{color: 'red'}}>🚫 Cheating will NOT be tolerated!🚫</span></strong></p>
